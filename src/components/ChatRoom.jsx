...
const ChatRoom = () => {
    ...
    useEffect(() => {
        //const socket = io("https://juschat-server.herokuapp.com/")
    ...
    return (
        <div className="py-4 m-5 w-50 shadow bg-white text-dark border rounded container" >
                            ...
                            <div key={index} className="row justify-content-end pl-5 ">
                                <div className="d-flex flex-column align-items-end m-2 shadow p-2 bg-success border rounded w-auto">
                                    <div>
                                        ...
                                        <small className="text-white-50 m-1"><Moment fromNow>{msg.time}</Moment></small>
                                    </div>
                ...
                <div className="form-group d-flex">
                    ...
                    <button type="button" className="btn btn-success mx-2" disabled={loading} onClick={onSubmit}>
                        {
                            loading
                            ?
